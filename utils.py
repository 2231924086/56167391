...
def parse_args():
    ...
    parser.add_argument("--user_hidden_size", default=16, type=int, help="user embedding dimension")
    ...
    parser.add_argument("--wave",default="haar",type=str)
    parser.add_argument("--n",default=-1,type=int)
    parser.add_argument("--decomp_level",default=2,type=int)
    ...
    if args.model_type.lower() == 'bsarec':
        ...
        parser.add_argument("--not_restore", action="store_true",
                            help="Only use low-pass filtered signal without high frequency components")
